...
export const AUTO_RULES = [
  ...
  { eventKey: "account_locked", group: "Tài khoản", name: "Tài khoản bị khóa", enabled: true, channels: ["In-app", "Email", "SMS"], throttleMinutes: 10, lastTriggeredAt: null },
  ...
  { eventKey: "wallet_topup_failed", group: "Ví", name: "Nạp tiền thất bại", enabled: true, channels: ["In-app", "Email", "SMS"], throttleMinutes: 20, lastTriggeredAt: null },
  ...
  { eventKey: "wallet_low_balance", group: "Ví", name: "Số dư thấp", enabled: true, channels: ["In-app", "SMS"], throttleMinutes: 60, lastTriggeredAt: null },
  ...
  { eventKey: "parking_spot_reserved", group: "Đỗ xe", name: "Vị trí đã chỉ dụng", enabled: true, channels: ["In-app", "SMS"], throttleMinutes: 15, lastTriggeredAt: null },
  { eventKey: "parking_almost_expired", group: "Đỗ xe", name: "Sắp hết hạn đỗ xe", enabled: true, channels: ["In-app", "Push"], throttleMinutes: 10, lastTriggeredAt: null },
  { eventKey: "parking_overdue", group: "Đỗ xe", name: "Quá hạn đỗ xe", enabled: true, channels: ["In-app", "SMS"], throttleMinutes: 10, lastTriggeredAt: null },
  { eventKey: "parking_vehicle_detected", group: "Đỗ xe", name: "Phát hiện xe", enabled: true, channels: ["In-app", "Push"], throttleMinutes: 20, lastTriggeredAt: null },
  ...
  { eventKey: "system_security_alert", group: "Hệ thống", name: "Cảnh báo bảo mật", enabled: true, channels: ["In-app", "Email", "SMS"], throttleMinutes: 30, lastTriggeredAt: null },
