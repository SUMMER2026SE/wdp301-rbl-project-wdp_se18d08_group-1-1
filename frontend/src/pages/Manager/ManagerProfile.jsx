      ...
      {readOnly ? (
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            style={{ borderBottom: "1px solid #10b981", color: "#e2e1eb" }}
          />
        ...
        <div
          ...
          onMouseEnter={(e) => (e.currentTarget.style.borderBottomColor = "rgba(52,211,153,0.5)")}
    ...
    >
      ...
      <section className="px-8 py-8 grid grid-cols-12 gap-8 flex-1">
        ...
        <div className="col-span-12 md:col-span-7">
          ...
          <div className="pt-6 flex items-center gap-3">
            ...
            <button
              ...
              style={{ border: editMode ? "1px solid rgba(239,68,68,0.6)" : `1px solid ${ACCENT}`, transition: "transform 0.2s cubic-bezier(0.23,1,0.32,1)", background: "transparent" }}
            >
              <span className="relative z-10 font-semibold tracking-wider text-xs transition-colors duration-300" style={{ color: editMode ? "rgba(239,68,68,0.8)" : ACCENT }}>
                {editMode ? "Cancel" : "Edit Profile"}
              </span>
              <div className="absolute inset-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" style={{ background: editMode ? "rgba(239,68,68,0.1)" : ACCENT }} />
            </button>
          </div>
        </div>
        ...
        <div className="col-span-12 md:col-span-5">
          <h3 className="text-2xl font-bold mb-10" style={{ color: ACCENT_TEXT }}>Security</h3>
          ...
          {!cpOpen ? (
            ...
            (() => {
              ...
              const fieldStyle = (hasError) => ({ width: "100%", background: "transparent", border: "none", borderBottom: hasError ? "1px solid rgba(239,68,68,0.7)" : `1px solid ${ACCENT_BORDER}`, padding: "8px 36px 8px 0", color: "#e2e1eb", fontSize: "13px", outline: "none", caretColor: ACCENT, transition: "border-color 0.2s" });
              const onFocusEmerald = (e) => (e.currentTarget.style.borderColor = ACCENT);
              const onBlurEmerald = (hasErr) => (e) => { e.currentTarget.style.borderColor = hasErr ? "rgba(239,68,68,0.7)" : ACCENT_BORDER; };
                ...
                return (
                  <div className="space-y-6" style={{ animation: "cp-slideDown 0.3s ease-out" }}>
                    ...
                    <button onClick={handleFpVerifyOTP} disabled={fpLoading || fpOtpDigits.join("").length !== 6}
                      ...
                      style={{ background: fpOtpDigits.join("").length === 6 ? ACCENT : ACCENT_BG, color: fpOtpDigits.join("").length === 6 ? "#050505" : ACCENT_DIM, cursor: fpLoading || fpOtpDigits.join("").length !== 6 ? "not-allowed" : "pointer" }}
                    >
                  ...
                  <div className="space-y-6" style={{ animation: "cp-slideDown 0.3s ease-out" }}>
                    ...
                    <div>
                      ...
                      <div className="relative mt-1.5">
                        ...
                        <button type="button" onClick={() => setFpShow((p) => ({ ...p, newPwd: !p.newPwd }))} className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-600 hover:text-emerald-400 transition-colors">
                    ...
                    {fpStrength === 4 && (
                      <div style={{ animation: "cp-slideDown 0.35s cubic-bezier(0.22,1,0.36,1)" }}>
                        ...
                        <div className="relative mt-1.5">
                          ...
                          <button type="button" onClick={() => setFpShow((p) => ({ ...p, confirm: !p.confirm }))} className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-600 hover:text-emerald-400 transition-colors">
                ...
                <div className="space-y-6" style={{ animation: "cp-slideDown 0.3s ease-out" }}>
                  ...
                  {!isGoogleUser && (
                    <div>
                      ...
                      <div className="relative mt-1.5">
                        ...
                        />
                        <button type="button" onClick={() => setCpShow((p) => ({ ...p, current: !p.current }))} className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-600 hover:text-emerald-400 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="relative mt-1.5">
                      ...
                      />
                      <button type="button" onClick={() => setCpShow((p) => ({ ...p, newPwd: !p.newPwd }))} className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-600 hover:text-emerald-400 transition-colors">
                  ...
                  {strength === 4 && newDiffersFromCurrent && (
                    <div style={{ animation: "cp-slideDown 0.35s cubic-bezier(0.22,1,0.36,1)" }}>
                      ...
                      <div className="relative mt-1.5">
                        ...
                        />
                        <button type="button" onClick={() => setCpShow((p) => ({ ...p, confirm: !p.confirm }))} className="absolute right-0 top-1/2 -translate-y-1/2 text-gray-600 hover:text-emerald-400 transition-colors">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button onClick={handleChangePwd} disabled={!cpIsValid || cpLoading}
                      className="relative overflow-hidden flex items-center gap-2 px-6 py-2.5 rounded-full text-xs font-bold tracking-wider"
                      style={{ background: cpIsValid ? ACCENT : ACCENT_BG, color: cpIsValid ? "#050505" : ACCENT_DIM, border: cpIsValid ? "none" : `1px solid ${ACCENT_BORDER}`, cursor: cpIsValid && !cpLoading ? "pointer" : "not-allowed", boxShadow: cpIsValid ? `0 0 22px ${ACCENT_GLOW}` : "none", transition: "all 0.3s" }}
                    >
