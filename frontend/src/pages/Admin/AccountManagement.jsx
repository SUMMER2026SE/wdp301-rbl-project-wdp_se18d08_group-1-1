...
import {
  ...
  CheckSquare, Square, RefreshCw, Layers, Eye
} from 'lucide-react';
...
export default function AccountManagement() {
  ...
  const openPanel = (u) => { setPanelUser(u); setIsEditing(false); setPanelTab('overview'); setBlockConfirm(false); setSaveState('idle'); };
